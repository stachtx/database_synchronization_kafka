...
import com.database.integration.external.services.AccountUpdateService;
...
public class AccountController {
    ...
    public ResponseEntity<?> saveAccountAfterEdit(@RequestBody AccountDto data, @RequestBody List<String> roles) throws SystemBaseException {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<?> safeProfileAfterEdit(@RequestBody AccountDto data)throws SystemBaseException {
